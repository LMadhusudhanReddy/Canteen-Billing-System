...
img= (Image.open("D://Wall Papers//download.png"))

#Resize the Image using resize method
resized_image= img.resize((1600,800), Image.ANTIALIAS)
...
# main title
label8 = Label(window, text="Canteenn Restaurant",
			font="times 28 bold")
label8.place(x=800, y=30, anchor="center")
